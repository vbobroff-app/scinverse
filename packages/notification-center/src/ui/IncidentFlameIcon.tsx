...
import styles from './IncidentFlameIcon.module.css';
...
/**
 * Иконка Incident: material-style flame (заголовок Thread).
 * Размер ≈ глиф «[I]».
 */
export function IncidentFlameIcon({ title = 'Incident', className }: Props) {
  const svg = (
    <span
