...
builder.Services.AddSingleton<NotificationPersistQueue>();
...
builder.Services.AddSingleton<HostOutageTransportEmitter>(); // Apply = no-op NC; слот T
builder.Services.AddSingleton<HostOutageConnectionEmitter>();
