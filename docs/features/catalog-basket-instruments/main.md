...
C0–C3 DONE · life-cycle DONE (checkup с 04:00 МСК; гейт суток в `ohs_runtime_state`) ·
schedule / spec-instruments — DRAFT.
...
| [`spec-instruments/`](spec-instruments/spec.md) | DRAFT · [spec](spec-instruments/spec.md) | Карточка инструмента: реальный sec_info (не 3-я пятница); мультитаб Инфо/Торговля/Торги/Эмитент/Новости |
...
| **v1.1+** | unified schedule, spec-instruments (sec_info + мультитаб), dynamic ATM, `has_data`, … |
