# Phase 8 — Schedule as projection (to-be)

**Статус:** `DESIGN AGREED` · **в коде:** ScheduleCutter + Write Gaps (Writers) · void mask
(Connection, `showScheduleMask`) · P3–P5 crash/journal — DONE · дом: [plan.md](plan.md).  
**Канон идеологии** для журнала OHS, Connection-ганта и writers (NC потребляет факты).
