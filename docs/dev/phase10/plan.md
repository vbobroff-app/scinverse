...
[stage1/apply.md](../../stage1/apply.md); детали реализации — в [apply.md](apply.md); статус — в
[report.md](report.md).

**Статус:** `PLANNED`. **Stage:** 2 (Multi-user & auth). **Зависимости:** нет жёстких; в gate перед
выносом сервисов (phase 11) и WebGL (phase 12). Влияет на все REST/WS-эндпоинты OHS.
