...
- `TimeframePanel` (по образцу `CategoryDropdown`): дропдауны `D1–D30`/`W1–W4`/`M1–M12`/`Q1–Q4`/
  `Y1–Y10` (активный юнит подсвечен), кнопка `All`, чекбокс «учёт выходных», два `input[type=date]`
  + «Применить».
