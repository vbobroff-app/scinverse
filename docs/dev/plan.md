...
| 1 | Миграции под принятые решения | **Только `V003`** (derivative + instrument_risk) | TODO | — |
| 2 | OrderLog / Plaza2 (Решение 5) + мультиисточник (Решение 3) | **Позже**, при появлении второго источника | TODO | — |
| 3 | Проверки (build + unit + integration) | **В необходимом объёме** | TODO | — |
...
### Фаза 1. Миграция V003 (derivative + instrument_risk) — *TODO*
