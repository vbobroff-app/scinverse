...
| **11** | **NC:** лента Thread DONE; фокус **11.13 журнал инцидентов (DESIGN, БД NC)** | **IN PROGRESS** | [incident-journal](phase11/incident-journal.md) · [plan](phase11/plan.md) · handoff [`promt.md` §8](../promt.md) |
