...
**Текущий статус:** `MVP DONE` (Stage 1, 2026-08-04). Живой Transaq/Finam закрыт в 7h+.
Хвосты (тесты 7e.6, статус карточки → 7c.9) — [../stage1/abandoned.md](../stage1/abandoned.md).
