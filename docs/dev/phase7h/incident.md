...
> Журнал инцидентов (`incident` в OHS) — [`phase8/incident-journal.md`](../phase8/incident-journal.md).  
...
Справочник (исторический) по **разрывам захвата**: детект, liveness, gaps на Ганте инструментов.
