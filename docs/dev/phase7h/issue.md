...
**Закрыто (2026-08-04):** явный load ATM ±N — [../phase7i/issue.md](../phase7i/issue.md) **DONE**
(= 7h.OPT / 7i.OPT). Connect-dump по-прежнему может быть без OPT; путь — families → strikes →
`get_options`.
