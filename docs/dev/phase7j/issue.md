...
Статус: **КОД ГОТОВ** (I1–I5 реализованы, сборка + 131 unit-тест зелёные; ждёт живой приёмки на Finam id=3
после рестарта бэка и применения миграции V026). Диагностика — по живому тесту 23.07.2026.
