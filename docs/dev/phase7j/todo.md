...
| **I11 / 7j.21** | Рассинхрон Manager↔Hub; единый close-break; атомарный Adopt; снять костыли `auto:`/лента | **OPEN** — B1+B2+connect-fail готово; лента/`from+60s` осталось ([issue.md](issue.md) I11) |
