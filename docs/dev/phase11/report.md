...
**Текущий статус:** `IN PROGRESS` — Thread **DONE**; **11.13a–d DONE**;
следующий шаг **11.13e** ribbon. [incident-journal.md](incident-journal.md) §12.
...
| 11.13 | Журнал инцидентов (`incident` в **OHS**) | **11.13a–d DONE** → 11.13e | [incident-journal.md](incident-journal.md) §12 |
...
Лента NC v1 — **готова**. Журнал OHS: **11.13a–d DONE**; дальше **11.13e** ribbon.
