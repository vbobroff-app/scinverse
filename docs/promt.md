...
| **11** | **NC:** лента DONE; **11.13 журнал `incident` в OHS → 11.13c** | **АКТИВНЫЙ ФОКУС** | [incident-journal](./dev/phase11/incident-journal.md) · [plan](./dev/phase11/plan.md) · [to-threads](./dev/phase11/to-threads.md) |
...
- **Активный фокус — 11.13:** журнал `incident` в **OHS** — **11.13a–b DONE**; дальше **11.13c**
  API — [incident-journal.md](./dev/phase11/incident-journal.md) §12.
...
Дальше — **§12** (**11.13c** API `GET /api/incidents`).
...
| **phase11** | 11.1–11.12 + 11.7 **DONE**; **11.13a–b DONE** → **11.13c**. |
